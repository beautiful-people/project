    ...
    <div class="home clearfix">
      ...
      <div class="home-superstars">
        ...
        <div class="super-list">
          <el-carousel :interval="4000" type="card" height="420px" width="380px ">
            <el-carousel-item v-for="item in 1" :key="item">
              <img
                src="img/index-img/thetopby/three.jpg"
                @click="homeSuperstars(1)"
                alt
            ...
            <el-carousel-item v-for="item in 1" :key="item">
              <img
                src="img/index-img/thetopby/one.jpg"
                @click="homeSuperstars(2)"
                alt
                class="carousel_image_type"
              />
            </el-carousel-item>
            <el-carousel-item v-for="item in 1" :key="item">
              <img
                src="img/index-img/thetopby/two.jpg"
                @click="homeSuperstars(3)"
                alt
                class="carousel_image_type"
              />
            </el-carousel-item>
      ...
      <div class="home-superstars">
        ...
        <div class="home-most">
          <div
            class="most-list"
            @click="homeSuperstars(item.imgsId)"
      ...
      <div class="home-householdstyle">
        ...
        <div class="household-list">
          ...
          <div class="household-list-right">
            <div
              class="household-right-img"
              @click="homeSuperstars(item.imgsId)"
              v-for="(item,index) in foterimg"
              :key="index"
            >
...
export default {
  ...
  created() {
    ...
    this.axios
      .post("/findUser") //在括号中，需要请求数据需要在("/",{})括号中需要的请求。
      .then(res => {
